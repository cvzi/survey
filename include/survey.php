...
// Template auswählen
$smarty->assign('moduleTpl', 'survey.html');

$survey = new Survey($errors,$surveyfile,$mysql);

$everythingForVoting = $survey->getEverythingForVoting($user->get('uid'));
$smarty->assign('everythingForVoting', $everythingForVoting);
